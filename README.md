...
Goofy is a *collaboratively funded project*. If you use
Goofy commercially we strongly encourage you to invest in its
continued development by [signing up for a paid plan][funding].

The initial aim is to provide a single full-time position on Goofy.
